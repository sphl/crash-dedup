...
from crash_dedup.container.summary import DedupSummary
from crash_dedup.grouping import group_by
...
class TestGrouping(unittest.TestCase):
    def setUp(self) -> None:
        self.sanitizer_files = [
            Path(__file__).parent.parent / "data" / "test_files" / "sanitizer" / "test.703472",
            Path(__file__).parent.parent / "data" / "test_files" / "sanitizer" / "test.703480",
            Path(__file__).parent.parent / "data" / "test_files" / "sanitizer" / "test.703482",
            Path(__file__).parent.parent / "data" / "test_files" / "sanitizer" / "test.703486",
            Path(__file__).parent.parent / "data" / "test_files" / "sanitizer" / "test.703498",
            Path(__file__).parent.parent / "data" / "test_files" / "sanitizer" / "test.703500",
            Path(__file__).parent.parent / "data" / "test_files" / "sanitizer" / "test.703504",
            Path(__file__).parent.parent / "data" / "test_files" / "sanitizer" / "test.703506",
            Path(__file__).parent.parent / "data" / "test_files" / "sanitizer" / "test.703510",
            Path(__file__).parent.parent / "data" / "test_files" / "sanitizer" / "test.703512",
            Path(__file__).parent.parent / "data" / "test_files" / "sanitizer" / "test.703514",
            Path(__file__).parent.parent / "data" / "test_files" / "sanitizer" / "test.703515",
        ]
