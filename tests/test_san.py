...
from crash_dedup.container.san import (
    SanitizerOutput,
    StackFrame,
    frame_to_string,
    string_to_frame,
...
class TestSanitizerOutput(unittest.TestCase):
    def test_from_file(self) -> None:
        ...
        sanitizer_files = [
            ...
            Path(__file__).parent.parent / "data" / "test_files" / "sanitizer" / "test.703478",
            Path(__file__).parent.parent / "data" / "test_files" / "sanitizer" / "test.703498",
            Path(__file__).parent.parent / "data" / "test_files" / "sanitizer" / "test.703513",
